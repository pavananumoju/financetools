...
const tools = [
  ...
  },
  {
    ...
    href: '/job-offer-true-value-calculator',
    tag: 'Live',
    tagColor: 'bg-indigo-100 text-indigo-700',
    iconBg: 'bg-indigo-50 group-hover:bg-indigo-100',
  ...
  },
  {
    ...
    description: 'Check if you can safely switch now by modeling runway based on expenses, savings, and risk profile.',
    uniqueInsight: 'Shows earliest safe switch month + savings gap',
